            ...
            <section className="stage" ref="stage">
                <section className="img-sec">
                    {imgdatas.map(function (v, i) {
                        ...
                        contrllerUnits.push(<ControllerUnit arrange={this.state.imgsArrangeArr[i]}
                                                            inverse={this.inverse(i)} center={this.center(i)}/>)
                        return (<ImgFigure data={v} key={i} ref={'imgFigure'+i} arrange={this.state.imgsArrangeArr[i]}
                                           inverse={this.inverse(i)} center={this.center(i)}/>)
                    }.bind(this))}
                </section>
